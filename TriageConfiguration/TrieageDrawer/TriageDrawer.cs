...
namespace TriageConfiguration.TrieageDrawer
{
    ...
    {
        public static string Draw(TriageConfig? triageConfig, ITriageDrawer triageDrawer)
        {
            triageDrawer.StartSet(triageConfig?.CustomerName, triageConfig?.Description);
